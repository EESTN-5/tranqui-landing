...
export default function Home() {
    const TEXTS: string[] = [
        ...
        "Así, un segundo grupo de estudiantes de la EEST Nº5 supervisados por el prof. Abdala Achaval, desarrolló la versión que aquí se presenta. Ellos son: Est. Tomás Di Mauro (coordinador), Est. Facundo Nicolás Berardi Hernández, Est. Alan Barbé, Est. Santino Ian Cruz Cataldo Rodríguez, Est. Matías Nicolás Celiz Ramos, Est. Alan Gabriel Córdoba, Est. Kiara Enríquez y Est. Luca Nahuel López."
    ]
    return (
